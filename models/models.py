...
cb = Table('cbs', metadata,
           ...
           Column('active_year', Integer),
           Column('apply_total_amount', BigInteger),
           Column('publish_total_amount', BigInteger),
           Column('publish_price', Float),
           Column('conversion_price', Float),
           Column('conversion_stock', Integer),
           Column('start_conversion_date', Date),
           Column('end_conversion_date', Date),
           Column('conversion_premium_rate', Float),
