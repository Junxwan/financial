...
def main(event, context):
    ...
    data = [
        ...
        ['經濟日報-產業熱點', news.money_udn_rss('5591', '5612', date)],
        ['經濟日報-生技醫藥', news.money_udn_rss('5591', '10161', date)],
        ['經濟日報-企業CEO', news.money_udn_rss('5591', '5649', date)],
        ['經濟日報-總經趨勢', news.money_udn_rss('10846', '10869', date)],
        ['經濟日報-2021投資前瞻', news.money_udn_rss('10846', '121887', date)],
        ['經濟日報-國際焦點', news.money_udn_rss('5588', '5599', date)],
        ['經濟日報-美中貿易戰', news.money_udn_rss('5588', '10511', date)],
        ['經濟日報-金融脈動', news.money_udn_rss('12017', '5613', date)],
        ['經濟日報-市場焦點', news.money_udn_rss('5590', '5607', date)],
        ['經濟日報-集中市場', news.money_udn_rss('5590', '5710', date)],
        ['經濟日報-櫃買市場', news.money_udn_rss('5590', '11074', date)],
        ['經濟日報-國際期貨', news.money_udn_rss('11111', '11114', date)],
        ['經濟日報-國際綜合', news.money_udn_rss('12925', '121854', date)],
        ['經濟日報-外媒解析', news.money_udn_rss('12925', '12937', date)],
        ['經濟日報-產業動態', news.money_udn_rss('12925', '121852', date)],
        ['經濟日報-產業分析', news.money_udn_rss('12925', '12989', date)],
        ['經濟日報-證卷', news.money_udn_stock(date)],
